...
<?php $__env->startSection('title', 'Profil Maison Fashion Boutique'); ?>
        ...
        <div class="col-md-5">
            <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100">
                ...
                <div class="mx-auto mb-3 overflow-hidden shadow-sm rounded-4" style="width: 110px; height: 110px; border: 3px solid #fae1dd;">
                    <img src="<?php echo e(asset('img/images.png')); ?>" alt="Foto Maison Fashion Boutique" class="w-100 h-100" style="object-fit: cover;">
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\APK_POSKEYLA4\resources\views/maison_profile.blade.php ENDPATH**/ ?>