<nav class="navbar navbar-expand-lg navbar-custom sticky-top">
    <div class="container">
        ...
        <a class="navbar-brand d-flex align-items-center gap-2" href="<?php echo e(route('boutique.profile')); ?>">
            <div class="logo-fashion-wrapper shadow-sm">
                <img src="<?php echo e(asset('img/images.png')); ?>" alt="Foto Maison Fashion Boutique" class="logo-fashion-img">
            </div>
...
</nav><?php /**PATH C:\laragon\www\APK_POSKEYLA4\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>