            ...
            <div class="card dashboard-card border-0 p-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control bg-light border-0" value="<?php echo e($user->name); ?>" readonly disabled>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control bg-light border-0" value="<?php echo e($user->email); ?>" readonly disabled>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\APK_POSKEYLA4\resources\views/profile/show.blade.php ENDPATH**/ ?>